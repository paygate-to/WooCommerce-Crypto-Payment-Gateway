...
protected $verseerc20_tolerance_percentage;
protected $icon_url;
    ...
    public function __construct() {
		...
		$this->verseerc20_tolerance_percentage = sanitize_text_field($this->get_option('verseerc20_tolerance_percentage'));
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'verseerc20_tolerance_percentage' => array(
    ...
    public function process_payment($order_id) {
		...
		$paygatedottocryptogateway_verseerc20_tolerance_percentage = $this->verseerc20_tolerance_percentage;
...
if ($paygatedottocryptogateway_verseerc20_genqrcode_conversion_resp && isset($paygatedottocryptogateway_verseerc20_genqrcode_conversion_resp['qr_code'])) {
	...
	$order->add_meta_data('paygatedotto_verseerc20_tolerance_percentage', $paygatedottocryptogateway_verseerc20_tolerance_percentage, true);
...
function paygatedottocryptogateway_verseerc20_change_order_status_callback( $request ) {
	...
	$paygatedottocryptogateway_verseerc20expected_amount = $order->get_meta('paygatedotto_verseerc20_payin_amount', true) * $order->get_meta('paygatedotto_verseerc20_tolerance_percentage', true);
